...
The Dark Index does not receive this information in the Core beta because the
beta has no account, cloud backup, synchronization, or metadata service.
...
cloud account is created automatically, and the beta does not upload collection
data to a Dark Index service. This policy will be revised before account,
billing, cloud, metadata-provider, notification, or remote-diagnostics
